...
### Planned
- **Multi-layout import** phase 4 — [docs/import-layouts-plan.md](./docs/import-layouts-plan.md) (Computershare VGS/IOZ + Link/MUFG NDQ PDF layouts). Phases 0–3 + 5 done (see Added).
