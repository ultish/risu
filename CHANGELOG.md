...
### Planned
- **Multi-layout import** phases 3–4 — [docs/import-layouts-plan.md](./docs/import-layouts-plan.md) (PDF layouts: Computershare, Link/MUFG, Betashares Direct). Phases 0–2 + 5 done (see Added).
